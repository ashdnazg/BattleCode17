...
import johnny4_seeding.Counter;
...
public class Radio {
    ...
    public Radio(RobotController rc_) {
        ...
        johnny4_seeding.Counter.rc = rc_;
        Stream.rc = rc_;
    ...
    public static void keepAlive() throws GameActionException {
        ...
        if (previousRoundNum < frame) {
            ...
            allyCounts[0] = johnny4_seeding.Counter.commit(400) + johnny4_seeding.Counter.commit(406);
            allyCounts[1] = johnny4_seeding.Counter.commit(401) + johnny4_seeding.Counter.commit(407);
            allyCounts[2] = johnny4_seeding.Counter.commit(402) + johnny4_seeding.Counter.commit(408);
            allyCounts[3] = johnny4_seeding.Counter.commit(403) + johnny4_seeding.Counter.commit(409);
            allyCounts[4] = johnny4_seeding.Counter.commit(404) + johnny4_seeding.Counter.commit(410);
            allyCounts[5] = johnny4_seeding.Counter.commit(405) + johnny4_seeding.Counter.commit(411);
            activeGardenersCount = johnny4_seeding.Counter.commit(426);
            ...
            allyCounts[0] = johnny4_seeding.Counter.get(400) + johnny4_seeding.Counter.get(406);
            allyCounts[1] = johnny4_seeding.Counter.get(401) + johnny4_seeding.Counter.get(407);
            allyCounts[2] = johnny4_seeding.Counter.get(402) + johnny4_seeding.Counter.get(408);
            allyCounts[3] = johnny4_seeding.Counter.get(403) + johnny4_seeding.Counter.get(409);
            allyCounts[4] = johnny4_seeding.Counter.get(404) + johnny4_seeding.Counter.get(410);
            allyCounts[5] = johnny4_seeding.Counter.get(405) + johnny4_seeding.Counter.get(411);

            activeGardenersCount = johnny4_seeding.Counter.get(426);
        ...
        johnny4_seeding.Counter.increment(400 + myType);

        // Only gardeners have buildees
        if (myType == 1) {
            if (frame <= (buildees[0] & 0xFFFF)) {
                int robotType = buildees[0] >>> 16;
                johnny4_seeding.Counter.increment(406 + robotType);
            }
    ...
    public static void reportBuild(RobotType robotType) throws GameActionException {
        ...
        johnny4_seeding.Counter.increment(406 + index);
