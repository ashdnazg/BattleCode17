...
public class BuildPlanner {
    ...
    public static void init() {
        ...
        for (MapLocation myArch : rc.getInitialArchonLocations(rc.getTeam())) {
            for (MapLocation archonPos : johnny4_seeding.Map.enemyArchonPos) {
    ...
    public static void update(RobotInfo[] nearbyRobots, TreeInfo[] nearbyTrees) throws GameActionException {
        ...
        johnny4_seeding.BuildPlanner.nearbyTrees = nearbyTrees;
        ...
        myTrees = johnny4_seeding.TreeStorage.ownTrees + TreeStorage.otherTrees * (nearbyGardeners == 0 ? 1 : 0.5f);
