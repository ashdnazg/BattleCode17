...
public class Soldier {
    ...
    public Soldier(RobotController rc) {
        ...
        this.map = new johnny4_seeding.Map(rc, radio);
    ...
    protected void tick() {
        try {
            ...
            if (nextEnemy == null) {
                ...
                nextEnemy = johnny4_seeding.Map.getTarget(map.ARCHON, map.GARDENER, map.LUMBERJACK, map.SCOUT, map.SOLDIER, map.TANK, 1, myLocation);
                if (nextEnemy == null){
                    if (Util.DEBUG) System.out.println("Using long range target fallback");
                    nextEnemy = johnny4_seeding.Map.getTarget(map.ARCHON, map.GARDENER, map.LUMBERJACK, map.SCOUT, map.SOLDIER, map.TANK, 0, myLocation);
                }
            ...
            if (nextEnemy != null) {
                ...
                if ((enemyType != RobotType.SOLDIER || (money > 50 && evasionMode)) && enemyType != RobotType.LUMBERJACK) {
