...
public class Radio {
    ...
    public static float getMapMinX() throws GameActionException {
        return rc.readBroadcastFloat(1000);
    }

    public static void setMapMinX(float value) throws GameActionException {
        rc.broadcastFloat(1000, value);
    }

    public static float getMapMaxX() throws GameActionException {
        return rc.readBroadcastFloat(1001);
    }

    public static void setMapMaxX(float value) throws GameActionException {
        rc.broadcastFloat(1001, value);
    }

    public static float getMapMinY() throws GameActionException {
        return rc.readBroadcastFloat(1002);
    }

    public static void setMapMinY(float value) throws GameActionException {
        rc.broadcastFloat(1002, value);
    }

    public static float getMapMaxY() throws GameActionException {
        return rc.readBroadcastFloat(1003);
    }

    public static void setMapMaxY(float value) throws GameActionException {
        rc.broadcastFloat(1003, value);
    }
}
