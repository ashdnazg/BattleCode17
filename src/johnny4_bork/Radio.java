...
public class Radio {
    ...
    public static void updateEnemyCounts() throws GameActionException {
        ...
        if (johnny4_bork.Util.DEBUG) System.out.println("Enemy Archons: " + enemyCounts[0]);
        if (johnny4_bork.Util.DEBUG) System.out.println("Enemy Gardeners: " + enemyCounts[1]);
        if (johnny4_bork.Util.DEBUG) System.out.println("Enemy Lumberjacks: " + enemyCounts[2]);
        if (johnny4_bork.Util.DEBUG) System.out.println("Enemy Soldiers: " + enemyCounts[3]);
        if (johnny4_bork.Util.DEBUG) System.out.println("Enemy Tanks: " + enemyCounts[4]);
        if (johnny4_bork.Util.DEBUG) System.out.println("Enemy Scouts: " + enemyCounts[5]);
    ...
    public static void keepAlive() throws GameActionException {
        ...
        if (previousRoundNum < frame) {
            ...
            if (johnny4_bork.Util.DEBUG) System.out.println("Allied Scouts: " + countAllies(RobotType.SCOUT));
            if (johnny4_bork.Util.DEBUG) System.out.println("Allied Soldiers: " + countAllies(RobotType.SOLDIER));
            if (johnny4_bork.Util.DEBUG) System.out.println("Allied Lumberjacks: " + countAllies(RobotType.LUMBERJACK));
            if (johnny4_bork.Util.DEBUG) System.out.println("Allied Gardeners: " + countAllies(RobotType.GARDENER));
    ...
    public static void deleteEnemyReport(MapLocation location) throws GameActionException {
        if (johnny4_bork.Util.DEBUG) System.out.println("Clearing invalid report at " + location);
        if (johnny4_bork.Util.DEBUG) rc.setIndicatorDot(location, 255, 0, 0);
