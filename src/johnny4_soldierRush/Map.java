...
public class Map {
    ...
    public Map(RobotController rc, johnny4_soldierRush.Radio radio) {
        this.rc = rc;
        this.radio = radio;
    ...
    final int LUMBERJACK = johnny4_soldierRush.Radio.typeToInt(RobotType.LUMBERJACK);
    final int SOLDIER = johnny4_soldierRush.Radio.typeToInt(RobotType.SOLDIER);
    final int TANK = johnny4_soldierRush.Radio.typeToInt(RobotType.TANK);
    final int SCOUT = johnny4_soldierRush.Radio.typeToInt(RobotType.SCOUT);
    final int ARCHON = johnny4_soldierRush.Radio.typeToInt(RobotType.ARCHON);
    final int GARDENER = johnny4_soldierRush.Radio.typeToInt(RobotType.GARDENER);
