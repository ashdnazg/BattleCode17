...
public class Radio {
    ...
    public static void updateEnemyCounts() throws GameActionException {
        ...
        if (johnny4_sprint.Util.DEBUG) System.out.println("Enemy Archons: " + enemyCounts[0]);
        if (johnny4_sprint.Util.DEBUG) System.out.println("Enemy Gardeners: " + enemyCounts[1]);
        if (johnny4_sprint.Util.DEBUG) System.out.println("Enemy Lumberjacks: " + enemyCounts[2]);
        if (johnny4_sprint.Util.DEBUG) System.out.println("Enemy Soldiers: " + enemyCounts[3]);
        if (johnny4_sprint.Util.DEBUG) System.out.println("Enemy Tanks: " + enemyCounts[4]);
        if (johnny4_sprint.Util.DEBUG) System.out.println("Enemy Scouts: " + enemyCounts[5]);
    ...
    public static void keepAlive() throws GameActionException {
        ...
        if (previousRoundNum < frame) {
            ...
            allyCounts[0] = johnny4_sprint.Counter.commit(400) + johnny4_sprint.Counter.commit(406);
            allyCounts[1] = johnny4_sprint.Counter.commit(401) + johnny4_sprint.Counter.commit(407);
            allyCounts[2] = johnny4_sprint.Counter.commit(402) + johnny4_sprint.Counter.commit(408);
            allyCounts[3] = johnny4_sprint.Counter.commit(403) + johnny4_sprint.Counter.commit(409);
            allyCounts[4] = johnny4_sprint.Counter.commit(404) + johnny4_sprint.Counter.commit(410);
            allyCounts[5] = johnny4_sprint.Counter.commit(405) + johnny4_sprint.Counter.commit(411);
            activeGardenersCount = johnny4_sprint.Counter.commit(426);

            processDeleteRequests();

            updateEnemyCounts();

            if (johnny4_sprint.Util.DEBUG) System.out.println("Allied Scouts: " + countAllies(RobotType.SCOUT));
            if (johnny4_sprint.Util.DEBUG) System.out.println("Allied Soldiers: " + countAllies(RobotType.SOLDIER));
            if (johnny4_sprint.Util.DEBUG) System.out.println("Allied Lumberjacks: " + countAllies(RobotType.LUMBERJACK));
            if (johnny4_sprint.Util.DEBUG) System.out.println("Allied Gardeners: " + countAllies(RobotType.GARDENER));


        } else {
            allyCounts[0] = johnny4_sprint.Counter.get(400) + johnny4_sprint.Counter.get(406);
            allyCounts[1] = johnny4_sprint.Counter.get(401) + johnny4_sprint.Counter.get(407);
            allyCounts[2] = johnny4_sprint.Counter.get(402) + johnny4_sprint.Counter.get(408);
            allyCounts[3] = johnny4_sprint.Counter.get(403) + johnny4_sprint.Counter.get(409);
            allyCounts[4] = johnny4_sprint.Counter.get(404) + johnny4_sprint.Counter.get(410);
            allyCounts[5] = johnny4_sprint.Counter.get(405) + johnny4_sprint.Counter.get(411);

            activeGardenersCount = johnny4_sprint.Counter.get(426);
        ...
        johnny4_sprint.Counter.increment(400 + myType);

        // Only gardeners have buildees
        if (myType == 1) {
            if (frame <= (buildees[0] & 0xFFFF)) {
                int robotType = buildees[0] >> 16;
                johnny4_sprint.Counter.increment(406 + robotType);
            }
    ...
    public static void reportBuild(RobotType robotType) throws GameActionException {
        ...
        johnny4_sprint.Counter.increment(406 + index);
    ...
    public static void deleteEnemyReport(MapLocation location) throws GameActionException {
        if (johnny4_sprint.Util.DEBUG) System.out.println("Clearing invalid report at " + location);
        if (johnny4_sprint.Util.DEBUG) rc.setIndicatorDot(location, 255, 0, 0);
    ...
    public static void reportActiveGardener() throws GameActionException {
        johnny4_sprint.Counter.increment(426);
    }
