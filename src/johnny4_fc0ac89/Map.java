...
public class Map {
    ...
    public Map(RobotController rc, johnny4_fc0ac89.Radio radio) {
        this.rc = rc;
        this.radio = radio;
    ...
    public RobotInfo[] sense() throws GameActionException {
        ...
        if (frame != lastSenseFrame) {
            ...
            johnny4_fc0ac89.Radio.reportEnemies(nearbyRobots);
    ...
    final int LUMBERJACK = johnny4_fc0ac89.Radio.typeToInt(RobotType.LUMBERJACK);
    final int SOLDIER = johnny4_fc0ac89.Radio.typeToInt(RobotType.SOLDIER);
    final int TANK = johnny4_fc0ac89.Radio.typeToInt(RobotType.TANK);
    final int SCOUT = johnny4_fc0ac89.Radio.typeToInt(RobotType.SCOUT);
    final int ARCHON = johnny4_fc0ac89.Radio.typeToInt(RobotType.ARCHON);
    final int GARDENER = johnny4_fc0ac89.Radio.typeToInt(RobotType.GARDENER);
